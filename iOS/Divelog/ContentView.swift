...
struct ContentView: View {
    ...
    @State private var editingEntry: DiveEntry?
    ...
    private func row(for entry: DiveEntry) -> some View {
        HStack {
...
struct EntryEditView: View {
    ...
    let existingId: UUID?
    let onSave: (DiveEntry) -> Void

    init(entry: DiveEntry?, onSave: @escaping (DiveEntry) -> Void) {
        ...
        NavigationStack {
            Form {
                Section("Dive details") {
                    ...
                    TextField("Dive Shop", text: $vendor)
            ...
            .navigationTitle(existingId == nil ? "Add Dive" : "Edit Dive")
            .toolbar {
                ...
                ToolbarItem(placement: .confirmationAction) {
                    Button("Save") {
                        ...
                        let entry = DiveEntry(
                            id: existingId ?? UUID(),
                            title: title.isEmpty ? "Dive" : title,
                            vendor: vendor,
                            amount: amount,
                            date: date,
                            notes: notes
